...
This is a copied version of multiprocessing.shared_memory with the following fix, in order to allow
unrelated processes to access the memory and exit without the memory being unlinked:

taken from: https://bugs.python.org/issue39959
by changing:
